...
char ssid[] = "Brokeback Idaho Love";  //  your network SSID (name)
...
void loop()
{
  ...
  if ((millis() - lastSecond) > 1000)
  {
    ...
    strip.setPixelColor(currentSecond / 2.5, 0, 0, 50);
    strip.setPixelColor(currentMinute / 2.5, 0, 75, 0);
    strip.setPixelColor(currentHour * 2, 75, 0, 0);
    strip.show();
  }
}
